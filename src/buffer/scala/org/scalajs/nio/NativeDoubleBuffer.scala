...
class NativeDoubleBuffer(protected var mCapacity: Int, protected var mLimit: Int, protected var mPosition: Int,
    protected var mMark: Int, mBuffer: js.Dynamic, mBufferOffset: Int) extends DoubleBuffer
  ...
  protected val typedArray = g.Float64Array(mBuffer, mBufferOffset, mCapacity).asInstanceOf[js.Array[js.Number]]
